...
APP_VERSION = "TARGET-2050.190"
BUILD = "REAL-WORLD-EXECUTION-ORCHESTRATOR-CORE"
...
def self_test_190():
    ...
    ck("version", lambda: APP_VERSION == "TARGET-2050.190")
    ck("orchestrator build", lambda: BUILD == "REAL-WORLD-EXECUTION-ORCHESTRATOR-CORE")
