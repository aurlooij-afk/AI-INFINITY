...
def safe_workspace_path(path):
 ...
 if candidate!=base and not candidate.startswith(base+os.sep):
  raise ValueError('workspace path traversal blocked')
 return candidate
...
def workspace_traversal_test():
 try:safe_workspace_path('../outside');return False
 except ValueError:return True
